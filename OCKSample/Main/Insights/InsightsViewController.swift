    ...
    */
    ...
    func taskViewController(for task: OCKAnyTask,
        ...
        case surveyTaskID:
            ...
            insightsCard.chartView.headerView.titleLabel.text = "Shampoo used"
        ...
        case TaskID.nausea:
            ...
            let doxylamineDataSeries = OCKDataSeriesConfiguration(
                taskID: TaskID.washFace,
                legendTitle: "Face washes",
                gradientStartColor: .systemGray2,
                gradientEndColor: .systemGray,
                markerSize: 10,
                eventAggregator: OCKEventAggregator.countOutcomeValues)
            ...
            insightsCard.chartView.headerView.titleLabel.text = "Diritness and Face Washings"
            insightsCard.chartView.headerView.detailLabel.text = "This Week"
